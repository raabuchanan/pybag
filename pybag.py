...
######################################################################################################################################
    ...
    position_figure.suptitle("Position and Rotation through 60cm Gap", fontsize=30)
...
######################################################################################################################################
    position_figure = plt.figure(0, figsize=(16, 9), dpi=120)
    position_figure.suptitle("Position and Rotation through Rotated Gap", fontsize=30)
    left_ax1 = plt.subplot(3, 1, 1)
    plt.plot(x_axis_values[start_index:end_index],
             rotation_values[start_index:end_index, 0], '--', color=(1, 0, 0), label='Roll (degrees)')
    #plt.xlabel('Time (s)')
...
#"args": ["/media/russellb/Bradburrito/JFR2019/jfr_data/bags/step/2019-07-21-12-07-50.bag", "/home/russellb/Dropbox/Apps/ShareLaTeX/Buchanan JFR 2019/figures/pdf/"],
    start_time = 0
    end_time = 200
